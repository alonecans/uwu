      ...
      try {
         ...
         mess = {
            ...
            only: {
               ...
               userB: `*Hallo kak ${pushname2} kamu belom tedaftar didatabase Manca-Bot silahkan ketik* \n${prefix}daftar`,
         ...
         if (messagesLink.includes('#menu')) {
            fahmi.updatePresence(from, Presence.composing);
            const loli = fs.readFileSync('./mp3/Onii-chan.mp3');
            fahmi.sendMessage(from, loli, MessageType.audio, { quoted: mek, mimetype: 'audio/mp4', ptt: true });
         }
         ...
         if (messagesLink.includes('#xᴠideos')) {
            fahmi.updatePresence(from, Presence.composing);
            const loli = fs.readFileSync('./mp3/astag.mp3');
            fahmi.sendMessage(from, loli, MessageType.audio, { quoted: mek, mimetype: 'audio/mp4', ptt: true });
         }
         if (messagesLink.includes('#nsfᴡloli')) {
            fahmi.updatePresence(from, Presence.composing);
            const loli = fs.readFileSync('./mp3/astag.mp3');
            fahmi.sendMessage(from, loli, MessageType.audio, { quoted: mek, mimetype: 'audio/mp4', ptt: true });
         }
         if (messagesLink.includes('#nsfᴡneko')) {
            fahmi.updatePresence(from, Presence.composing);
            const loli = fs.readFileSync('./mp3/astag.mp3');
            fahmi.sendMessage(from, loli, MessageType.audio, { quoted: mek, mimetype: 'audio/mp4', ptt: true });
         }
         if (messagesLink.includes('#nsfᴡbloᴡjob')) {
            fahmi.updatePresence(from, Presence.composing);
            const loli = fs.readFileSync('./mp3/astag.mp3');
            fahmi.sendMessage(from, loli, MessageType.audio, { quoted: mek, mimetype: 'audio/mp4', ptt: true });
         }
         if (messagesLink.includes('#nsfᴡtrap')) {
            fahmi.updatePresence(from, Presence.composing);
            const loli = fs.readFileSync('./mp3/astag.mp3');
            fahmi.sendMessage(from, loli, MessageType.audio, { quoted: mek, mimetype: 'audio/mp4', ptt: true });
         }
         ...
         if (messagesLink.includes('yamete onichan')) {
            fahmi.updatePresence(from, Presence.composing);
         ...
         if (messagesLink.includes('selamat malam')) {
            fahmi.updatePresence(from, Presence.composing);
            const loli = fs.readFileSync('./mp3/malam.mp3');
            fahmi.sendMessage(from, loli, MessageType.audio, { quoted: mek, mimetype: 'audio/mp4', ptt: true });
         }
         if (messagesLink.includes('selamat pagi')) {
            fahmi.updatePresence(from, Presence.composing);
         ...
         if (messagesLink.includes('@6283815956151')) {
            // respon tag ubah aja
            fahmi.updatePresence(from, Presence.composing);
            const d = fs.readFileSync('./sticker/iyhcayang.webp');
...
♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}ttp
♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}stike
♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}gifstike
...
♡ۣۜۜ፝͜͜͡͡✿➤ MHANKBARBAR`,
            ...
            case 'nsfwneko':
               try {
                  ...
                  buffer = await getBuffer(res.result);
                  fahmi.sendMessage(from, buffer, image, { quoted: mek, caption: 'Nih Kak Bokep Nsfw Neko Nya Xixixi' });
               } catch (e) {
                  console.log(`Error :`, color(e, 'red'));
                  reply(' *ERROR* ');
               }
            ...
            case 'nsfwtrap':
               try {
                  ...
                  buffer = await getBuffer(res.result);
                  fahmi.sendMessage(from, buffer, image, { quoted: mek, caption: 'Nih Kak Bokep Nsfw Trap Nya Xixixi' });
               } catch (e) {
                  console.log(`Error :`, color(e, 'red'));
                  reply(' *ERROR* ');
               }
            ...
            case 'hentai':
               try {
                  ...
                  buffer = await getBuffer(res.result);
                  fahmi.sendMessage(from, buffer, image, { quoted: mek, caption: 'Nih Kak Bokep Nsfw Hentai Nya Xixixi' });
               } catch (e) {
                  console.log(`Error :`, color(e, 'red'));
                  reply(' *ERROR* ');
               }
